...
//        Category::truncate(); //deletes all the existing data
//        Job::truncate(); //deletes all the existing data

        //user: factory created
//       $user = User::factory(20)->create();

        //specialized creation for categories
//        $it = Category::create([
...
//        ]);
        ...
        Job::factory(5)->create(); //creates user and also category
    }
}
